...
import org.fuin.code2svg.core.MultiLineCommentElement;
...
public class MultiLineCommentElementTest {
    ...
    public final void testUnmarshal() throws Exception {
        ...
        // TEST
        final MultiLineCommentElement testee = JaxbUtils.unmarshal(xml, (Class<?>[]) Code2SvgUtils.JAXB_CLASSES.toArray());
